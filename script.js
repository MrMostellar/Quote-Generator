...
function tweetQuote(){
    ...
    const twitterUrl = `https://twitter.com/intent/tweet?text=${quoteText.textContent} - ${authorText.textContent} \U+000A Generated by Quote Generator: ${sourceWebsite.hrefContent}`;
